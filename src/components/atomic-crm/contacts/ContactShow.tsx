    ...
    <>
      ...
      <MobileHeader>
        ...
        >
          ...
          <span className="sr-only">{translate("crm.filter.edit_record")}</span>
        </Button>
      </MobileHeader>
      <MobileContent>
        <div className="mb-6">
          <div className="flex items-center mb-4">
            ...
            <div className="mx-3 flex-1">
              ...
              <div className="text-sm text-muted-foreground">
                {record.title}
                {record.title && record.company_id != null && ` ${translate("crm.filter.at")} `}
        ...
        <Tabs defaultValue="notes" className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-10">
            <TabsTrigger value="notes">{translate("resources.notes.name", { smart_count: 2 })}</TabsTrigger>
            ...
            <TabsTrigger value="details">{translate("crm.section.details")}</TabsTrigger>
          </TabsList>
            ...
            <ReferenceManyField
              ...
              empty={
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  <p className="text-muted-foreground mb-4">{translate("crm.filter.no_notes_yet")}</p>
                  <Button
                    variant="outline"
          ...
          <TabsContent value="details" className="mt-4">
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold">{translate("crm.section.personal_info")}</h3>
                <Separator />
                <div className="mt-3">
                  <ContactPersonalInfo />
                </div>
              ...
              <div>
                <h3 className="text-lg font-semibold">{translate("resources.contacts.fields.background")}</h3>
                <Separator />
                <div className="mt-3">
              ...
              <div>
                <h3 className="text-lg font-semibold">{translate("resources.tags.name", { smart_count: 2 })}</h3>
                <Separator />
                <div className="mt-3">
                  <TagsListEdit />
                </div>
