        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button
              ...
              aria-label={translate("crm.action.filters")}
            >
          ...
          <SheetContent side="bottom" className="h-dvh p-4 flex flex-col">
            <SheetHeader className="-p-4">
              <SheetTitle>
                <h1 className="text-xl font-semibold">{translate("crm.action.filters")}</h1>
              </SheetTitle>
            </SheetHeader>
              ...
              <div className="flex w-full gap-4">
                <SheetClose asChild>
                  <Button
                    ...
                    className="flex-1"
                  >
                    {translate("crm.action.clear_filters")}
                  </Button>
                </SheetClose>
                <SheetClose asChild>
                  <Button className="flex-1">{translate("crm.action.apply")}</Button>
                </SheetClose>
              </div>
            </SheetFooter>
          </SheetContent>
